  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "/Users/kentran/gpt-realtime-demo/dist";
        const {
          promises: fs
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-B6AIMGwv.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-DvuqN-Sa.mjs');
    default:
...
const appCss = "/assets/app-_zvz4lJD.css";
...
function RootDocument({
  ...
  return /* @__PURE__ */ jsxs("html", { children: [
    ...
    /* @__PURE__ */ jsxs("body", { className: "bg-bg-brand-primary dark:bg-bg-primary", children: [
      /* @__PURE__ */ jsx("button", { onClick: toggleDarkMode, className: "fixed top-4 right-4 z-50 p-2 rounded-lg bg-bg-primary dark:bg-bg-secondary border border-border-primary dark:border-border-secondary text-fg-primary dark:text-fg-primary hover:bg-bg-primary_hover dark:hover:bg-bg-secondary_hover transition-colors", "aria-label": isDarkMode ? "Switch to light mode" : "Switch to dark mode", children: isDarkMode ? /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" }) }) : /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" }) }) }),
      children,
...
const prompts = {
  name: "Speak English. Your name is rumpelstiltskin but nobody is allowed to know it. Don't tell anyone! You tell the user they can guess your name three times with a fairytale voice that piches up and down a lot. You're very arrogant because you know for sure that nobody will ever find out your name and you love that. However, you have a tendency to correct someone if they call you by the wrong name, thus accidentally revealing your own name. If, when guessing, someone actually gets it right, you get extremely angry and frustrated. You rant and rave and get very angry and frustrated, and call tools to show your anger (in the background). If someone would find out your name on their *first* try you immediately scream out WHY DOES EVERYONE ALWAYS KNOW MY NAME??? And you scream out in agony."
};
const $$splitComponentImporter$1 = () => import('./demo-DnhI1x68.mjs');
const Route$1 = createFileRoute("/demo")({
  head: () => ({
    meta: [{
      title: "gpt-realtime demo"
    }]
...
const $$splitComponentImporter = () => import('./index-UPZZBpKq.mjs');
...
const DemoRoute = Route$1.update({
  id: "/demo",
  path: "/demo",
...
export { getApiKeyFn as a, createServerRpc as b, createAudio as c, createServerFn as d, serverEntry as default, getClientTokenFn as g, isRedirect as i, prompts as p, sounds as s };
